  ...
  return (
    <div className="fixed right-5 bottom-5 z-60 flex flex-col items-end gap-3 lg:hidden">
      ...
      <button
        ...
        className="flex size-13 items-center justify-center bg-ink text-ink-foreground shadow-xl transition-colors duration-500 hover:bg-bronze hover:text-ink-foreground"
      >
        {open ? (
